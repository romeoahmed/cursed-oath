...
public final class CursedOathClient implements ClientModInitializer {
    @Override
    public void onInitializeClient() {
        ClientEntityEvents.ENTITY_LOAD.register((entity, level) -> {
            if (entity instanceof DomainEntity domain) DomainIndex.add(domain);
        });
        EntityRenderers.register(TechniqueProjectiles.WAVE, TechniqueProjectileRenderer::new);
        EntityRenderers.register(TechniqueProjectiles.ORB, TechniqueProjectileRenderer::new);
        EntityRenderers.register(Domains.TYPE, DomainRenderer::new);
