...
internal class EffectMesh(
    ...
    fun sphere(
        ...
        val color = color(rgb, alpha * CORE_ALPHA)
    ...
    private fun color(
        rgb: Int,
        alpha: Float,
    ): Int = ((alpha.coerceIn(0f, 1f) * opacity * maxAlpha).toInt() shl ALPHA_SHIFT) or rgb
